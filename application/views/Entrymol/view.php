        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tanggal">Tanggal</label>
              <div class="col-md-6 col-sm-6 col-xs-12 item has-feedback">
                <input type="text" id="TRANSACTION_DATE" name="TRANSACTION_DATE" maxlength="10" class="form-control col-md-7 col-xs-12 dtpicker has-feedback-left" placeholder="<?php echo date("Y-m-d") ?>" value="<?php if(!empty($date)) { $newDate = date("Y-m-d", strtotime($date)); echo $newDate; } ?>" required="required" />
