...
class Entrycoal extends CI_Controller {
	...
	{
		if($this->session->userdata('logged_in')!="" && $this->session->userdata('id_level_user')=="1" || $this->session->userdata('id_level_user')=="4")
		{
