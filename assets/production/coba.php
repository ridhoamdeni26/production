...
<?php
    // $coba="SELECT * from SUJ_INV_INTERFACE_COAL_RS";
        ...
        $index++;
{
  ?>
    ...
    <tr>
    <td></td>
    <td><a href='#approve' onclick='action(<?=$index?>,"approve")' class='btn btn-round btn-success' data-toggle='modal' data-id='<?=$rows['ID']?>'>Approve</a></td>
    ...
    <td><a href='#myModal' class='btn btn-round btn-danger' onclick='action(<?=$index?>,"reject")' data-toggle='modal' data-id='<?=$rows['ID']?>'>Reject</a></td>
<?php
}
            }
          }
